...
public class JuomaAutomaatti {
	...
	public static void main(String[] args) {
		...
		do {
			...
			System.out.println();
			if (valinta == 1) {
				// Tämän if lauseen merkitystä en ymmärtänyt? Jos teet samanlaisen tarkastauksen valmistaKahvi() metodissa
				// Niin täällä sitä ei tarvitse toistaa
				
				if (maatti.kahvia >= 10) { // Poistetaan tällä if-elsellä tilttimahdollisuus jos säiliö on tyhjä
				
					// Miksi kutsut tässä maatti.onnistuuko() ?
					// Tämä ohjelmalogiikka kannattaisi kapseloida JuomaAutomaatti-luokan sisään, ei main-metodiin. 
					// Eli  tsekkaa valmistaKahvi() metodissa onnistuuko valmistus vai ei.
					// Näin pääohjelmasi yksinkertaisuu huomattavasti
				...
				// Kun viittaat luokan kapseloituihin muuttujiin, olisi korrektia käyttää gettereitä.
				// Tämä siksi, että jos main-metodi olisi toisessa luokassa, ei käyttämäsikaltainen viittaus olisi mahdollinen
			...
			// Täällä voisit tulostaa jonkun tekstin joka kertoo että ohjelman suoritus loppui
	}
